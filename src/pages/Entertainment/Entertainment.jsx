...
import { faMusic, faFilm, faLaugh } from '@fortawesome/free-solid-svg-icons';
...
export default function Entertainment() {
    ...
    return (
        <>
            ...
            {/* Trending Sections */}
            <section className="entertainment-trending" id="trending">
                <div className="container">
                    <h2 className="section-title">Trending Now 🔥</h2>
                    <div className="entertainment-trending-grid">
